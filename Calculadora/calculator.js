class Calculator{
    ...
    // e usado un switch para hacer las operaciones, el + antes de cada this es para forzar que sean numeros sin eso petaba fuerte
    calc(){
    ...
    // apartir de aqui esta lo del DOM
